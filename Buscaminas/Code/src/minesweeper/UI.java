...
public class UI extends JFrame
{
    ...
    {                
        ...
        // Frame settings
        String FRAME_TITLE = "Minesweeper ~ Developed by Haris Muneer";
        ...
        iT.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/clock.png"))));
        ...
        /**
         * Traducción al español del menú
         */
        //------------------Menu--------------------------//
        JMenuBar menuBar = new JMenuBar();

        JMenu gameMenu = new JMenu("Buscaminas");
         
        newGame = new JMenuItem("   Nuevo Juego");
        statistics = new JMenuItem("   Estadísticas");
        exit = new JMenuItem("   Salir");

        newGame.setName("Nuevo Juego");
        statistics.setName("Estadísticas");
        exit.setName("Salir");
        ...
        JLabel background = new JLabel(new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/2.jpg"))));
    ...
    public void setIcons()
    {
       //---------------------Set Icons-----------------------------//
        ...
        d = new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/redmine.png")));
        redMine =   resizeIcon(d, bWidth - bOffset, bHeight - bOffset);        

        d = new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/mine.png")));
        mine =   resizeIcon(d, bWidth - bOffset, bHeight - bOffset);        
        
        d = new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/flag.png")));
        flag =   resizeIcon(d, bWidth - bOffset, bHeight - bOffset);        
        
        d = new ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/tile.png")));
